...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function register(): void
    {
        $validated = $this->validate([
            ...
            'subdomain' => [
                'required', 'alpha_dash', 'unique:'.User::class,
                'not_in:www,admin,administrator,root,host,mail,web,website,blog,home,site,online,shop,store,app',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                'min:3', 'max:63',
            ],
    ...
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="subdomain" id="subdomain" class="block mt-1 w-full" type="text" name="subdomain"
                          required autocomplete="subdomain"/>
